...
function ($) {
    ...
    uploadForm.addEventListener('click', function (e) {
        shaclFile = null; //shaclFile should be generated by the answers

        e.preventDefault()

        startUpload(ontoFile, shaclFile);
    });
    ...
    let startUpload = function (ontology, shacl) {
        ...
        $.ajax({
            url: 'http://localhost:8080/ws/ontologyUpload',
            method: 'POST',
            type: 'POST',
            data: formData,
